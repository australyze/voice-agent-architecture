...
See [eval/gate/README.md](../eval/gate/README.md) for how to run the gate, PASS/FAIL rules, baseline ownership, judge policy, and what a green run does not claim. Required suites: `runtime-demo`, `knowledge`, `voice`, and `runtime-multi-agent`.
