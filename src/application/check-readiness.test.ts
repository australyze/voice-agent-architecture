...
import { createPersistenceStub } from "../adapters/persistence/test-persistence.js";
...
describe("checkReadiness", () => {
  it("should_use_the_persistence_port_instead_of_a_database_engine", async () => {
    ...
    const persistence: PersistencePort = createPersistenceStub(ping);
  ...
  it("should_surface_port_failures_without_connection_secrets", async () => {
    const persistence: PersistencePort = createPersistenceStub(async () => {
